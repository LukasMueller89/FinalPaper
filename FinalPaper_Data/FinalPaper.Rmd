...
p3 <- ggplot(data = merge10, aes(x = Date, y = CAC.Close.change)) + geom_line() + scale_x_continuous(breaks=seq(1991.1, 2015.4, 10)) + ggtitle("France | CAC40") + theme(plot.title = element_text(size=10)) + labs(x = "Quarters", y = "% change of Closing Value") + theme(legend.position="none") + theme(axis.text=element_text(size=8),
        axis.title=element_text(size=8))
### Great Britain
p4 <- ggplot(data = merge10, aes(x = Date, y = FTSE.Close.change)) + geom_line() + scale_x_continuous(breaks=seq(1991.1, 2015.4, 10)) + ggtitle("Great Britain | FTSE100") + theme(plot.title = element_text(size=10)) + labs(x = "Quarters", y = "% change of Closing Value") + theme(legend.position="none") + theme(axis.text=element_text(size=8),
        axis.title=element_text(size=8))
```
